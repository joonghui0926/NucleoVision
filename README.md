...
YOLO11n을 이용해 BBBC038 세포핵 현미경 이미지를 탐지하고, 세포핵 개수, 크기, 밀도, 탐지 오차율을 정량화하는 탐구 프로젝트입니다. 이 저장소는 `YOLO_세포이미지_정량화_탐구기획서.pdf`의 실험 A, B, C를 그대로 실행할 수 있도록 구성했습니다.
